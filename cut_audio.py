...
def cut_audio(input_path: str, start_time: str = None, end_time: str = None, 
    ...
    cut_duration_s = len(cut_audio) / 1000
...
def print_usage():
    ...
    print("=" * 80)
    print("\nUsage:")
    print("  python cut_audio.py <input_file> [options]")
    print("\nOptions:")
    ...
    print("\nExamples:")
    print("  python cut_audio.py audio.mp3 --start 1:30 --end 3:45")
    print("  python cut_audio.py audio.mp3 --start 0:01:30 --duration 2:15")
    print("  python cut_audio.py audio.mp3 --start 90 --end 225")
    print("  python cut_audio.py audio.mp3 --start 1:30 --end 3:45 --output my_cut.mp3")
    print("\nTime formats:")
    print("  - MM:SS (e.g., '1:30' = 1 minute 30 seconds)")
    print("  - HH:MM:SS (e.g., '0:01:30' = 1 minute 30 seconds)")
    print("  - Seconds (e.g., '90' = 90 seconds)")
    print("=" * 80)
